...
`define InstAddrError 1'b1
`define DataAddrError 1'b0
...
`define EXE_TLBP_OP  8'b11111100
`define EXE_TLBR_OP  8'b11111101
`define EXE_TLBWI_OP  8'b11111111
`define EXE_TLBWR_OP  8'b11111110
...
`define EXE_WAIT_OP 8'b01111111
...
`define CP0_REG_RANDOM_VAL 32'b00000000000000000000000000011111
`define CP0_REG_STATUS_VAL 32'b00000000010000000000000000000000
`define CP0_REG_CONFIG_VAL 32'b10000000000000001000000000000000
